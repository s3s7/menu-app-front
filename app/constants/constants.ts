...
export const SITE_META = {
  siteTitle: 'HayabusaMenu',
  brandMessage: '旅の準備を、もっとシンプルに。',
  siteDesc:
    'HayabusaMenuは、誰でも簡単に旅行プランを作成・共有できるサービスです。あなたの旅行が素晴らしい思い出になるようにサポートします。',
  siteUrl: 'https://www.hayabusamenu.com',
  siteLang: 'ja',
  siteLocale: 'ja_JP',
  siteType: 'website',
  siteStartYear: '2023',
  ...
  twitterText:
    'HayabusaMenuを使ってみたよ。簡単に旅行プランが作れて便利だから、みんなもぜひ試してみてね！',
}
...
export const PRIVACY_PAGE_DESC = `旅行プラン作成サービス「HayabusaMenu」の${PRIVACY_PAGE_TITLE}のページです。`

// 利用規約のメタ情報
export const TERMS_PAGE_TITLE = '利用規約'
export const TERMS_PAGE_DESC = `旅行プラン作成サービス「HayabusaMenu」の${TERMS_PAGE_TITLE}のページです。`

// 旅行プラン一覧のメタ情報
export const MENU_INDEX_PAGE_TITLE = '旅行プラン一覧'
export const MENU_INDEX_PAGE_DESC = `旅行プラン作成サービス「HayabusaMenu」の${MENU_INDEX_PAGE_TITLE}のページです。`

// 旅行プラン詳細のメタ情報
export const MENU_DESC_PAGE_TITLE = '旅行プラン詳細'
export const MENU_DESC_PAGE_DESC = `旅行プラン作成サービス「HayabusaMenu」の${MENU_DESC_PAGE_TITLE}のページです。`

// アカウント設定のメタ情報
export const SETTINGS_PAGE_TITLE = 'アカウント設定'
export const SETTINGS_PAGE_DESC = `旅行プラン作成サービス「HayabusaMenu」の${SETTINGS_PAGE_TITLE}のページです。`
...
export const FORM_CREATE_MENU = '旅行プラン作成'
export const FORM_CREATE_MENU_SECONDARY = 'さっそく準備する！'
export const FORM_MENU_PHOTO = '旅行写真変更'
export const FORM_MENU_PUBLISH_SETTINGS = '公開状態変更'
export const FORM_MENU_TITLE = '旅行タイトル変更'
export const FORM_MENU_DESTINATION = '旅行先変更'
export const FORM_COPY_MENU = '旅行プランコピー'
export const FORM_DELETE_MENU = '旅行プラン削除'
export const FORM_ADD_SPOT = 'スポット追加'
export const FORM_UPDATE_SPOT = 'スポット更新'
export const FORM_DELETE_SPOT = 'スポット削除'
export const FORM_DELETE_MENU_DATE = '日程削除'
...
// 旅行期間の上限値
export const MAX_MENU_DURATION = 10
...
// 旅行メモの設定値
export const MAX_MENU_MEMO = 1000
export const MENU_MEMO_ROWS = 20
...
// menuAPI
export const CREATE_MENU_SUCCESS_MSG = '旅行プランを作成しました。'
export const COPY_MENU_SUCCESS_MSG = '旅行プランをコピーしました。'
export const UPDATE_MENU_SUCCESS_MSG = '旅行プランを更新しました。'
export const UPDATE_MENU_PUBLISH_SETTINGS_SUCCESS_MSG =
  '公開状態を変更しました。'
export const UPDATE_MENU_TITLE_SUCCESS_MSG = '旅行タイトルを変更しました。'
export const UPDATE_MENU_DESTINATION_SUCCESS_MSG = '旅行先を変更しました。'
export const UPDATE_MENU_MEMO_SUCCESS_MSG = 'メモを更新しました。'
export const ADD_MENU_DATE_SUCCESS_MSG = '旅行日程を追加しました。'
export const UPDATE_MENU_DATE_SUCCESS_MSG = '旅行日程を変更しました。'
export const DELETE_MENU_SUCCESS_MSG = '旅行プランを削除しました。'
export const DELETE_MENU_DATE_SUCCESS_MSG = '旅行日程を削除しました。'
export const GET_MENU_ERROR_MSG = '旅行プランの取得に失敗しました。'
export const CREATE_MENU_ERROR_MSG = '旅行プランの作成に失敗しました。'
export const COPY_MENU_TITLE_ERROR_MSG = `コピー元の旅行タイトルは${MAX_MENU_TITLE_LENGTH - COPY_SUFFIX.length
  }文字以下にしてください。`
export const COPY_MENU_ERROR_MSG = '旅行プランのコピーに失敗しました。'
export const UPDATE_MENU_ERROR_MSG = '旅行プランの更新に失敗しました。'
export const UPDATE_MENU_PUBLISH_SETTINGS_ERROR_MSG =
  '公開状態の変更に失敗しました。'
export const UPDATE_MENU_TITLE_ERROR_MSG = '旅行タイトルの変更に失敗しました。'
export const UPDATE_MENU_DESTINATION_ERROR_MSG = '旅行先の変更に失敗しました。'
export const UPDATE_MENU_MEMO_ERROR_MSG = 'メモの更新に失敗しました。'
export const ADD_MENU_DATE_ERROR_MSG = '旅行日程の追加に失敗しました。'
export const UPDATE_MENU_DATE_ERROR_MSG = '旅行日程の変更に失敗しました。'
export const DELETE_MENU_ERROR_MSG = '旅行プランの削除に失敗しました。'
export const DELETE_MENU_DATE_ERROR_MSG = '旅行日程の削除に失敗しました。'
// spotAPI
...
export const UPLOAD_MENU_IMAGE_LOADING_MSG = '旅行写真を更新中です。'
export const UPLOAD_USER_ICON_SUCCESS_MSG = 'ユーザーアイコンを更新しました。'
export const UPLOAD_MENU_IMAGE_SUCCESS_MSG = '旅行写真を更新しました。'
...
export const UPLOAD_MENU_IMAGE_ERROR_MSG =
  '旅行写真のアップロードに失敗しました。'
// signup
...
export const MENU_IMAGES_DIRECTORY = 'menu_images'

// 旅行先の配列
export const MENU_DESTINATION_ITEMS = [
